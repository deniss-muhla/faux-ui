...
- The repository implements the `@faux-ui/ui` 1.0.0 contract.
- Treat root exports and `/dom`, `/tui`, `/testing`, and JSX runtime subpaths as public SemVer surface.
...
- [docs/spec.md](docs/spec.md): normative behavior; it wins when semantics are unclear.
...
- [docs/refactor/report.md](docs/refactor/report.md): historical evidence/rationale.
- [docs/refactor/tasks.md](docs/refactor/tasks.md): completed reset checklist.
- [docs/refactor/analisis.md](docs/refactor/analisis.md): historical investigation/checkpoints.
